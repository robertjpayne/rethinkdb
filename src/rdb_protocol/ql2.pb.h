...
#ifndef PROTOBUF_src_2frdb_5fprotocol_2fql2_2eproto__INCLUDED
#define PROTOBUF_src_2frdb_5fprotocol_2fql2_2eproto__INCLUDED
...
const Term_TermType Term_TermType_TermType_MAX = Term_TermType_GET_WRITE_HOOK;
...
class VersionDummy : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:VersionDummy) */ {
 public:
  ...
  inline VersionDummy* New() const PROTOBUF_FINAL { return New(NULL); }

  VersionDummy* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct protobuf_src_2frdb_5fprotocol_2fql2_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class Query_AssocPair : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Query.AssocPair) */ {
 public:
  ...
  inline Query_AssocPair* New() const PROTOBUF_FINAL { return New(NULL); }

  Query_AssocPair* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
class Query : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Query) */ {
 ...
 private:
  ...
  void set_has_obsolete_noreply();
  void clear_has_obsolete_noreply();
  void set_has_accepts_r_json();
  void clear_has_accepts_r_json();
...
class Backtrace : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Backtrace) */ {
 public:
  ...
  inline Backtrace* New() const PROTOBUF_FINAL { return New(NULL); }

  Backtrace* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
class Response : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Response) */ {
 ...
 private:
  ...
  void set_has_token();
  void clear_has_token();
  void set_has_backtrace();
  void clear_has_backtrace();
...
class Datum_AssocPair : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Datum.AssocPair) */ {
 public:
  ...
  inline Datum_AssocPair* New() const PROTOBUF_FINAL { return New(NULL); }

  Datum_AssocPair* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
class Datum : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Datum) */ {
 ...
 private:
  ...
  void set_has_r_num();
  void clear_has_r_num();
  void set_has_r_str();
  void clear_has_r_str();
...
class Term_AssocPair : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Term.AssocPair) */ {
 public:
  ...
  inline Term_AssocPair* New() const PROTOBUF_FINAL { return New(NULL); }

  Term_AssocPair* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
class Term : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Term) */ {
 public:
  ...
  inline Term* New() const PROTOBUF_FINAL { return New(NULL); }

  Term* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
#endif  // PROTOBUF_src_2frdb_5fprotocol_2fql2_2eproto__INCLUDED
