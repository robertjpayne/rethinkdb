...
public:
    ...
    void set_data(vector_t<ql::datum_t> &&_data);
    ...
    const vector_t<ql::datum_t> &data() const;
    const optional<ql::datum_t> &profile() const;
    const vector_t<Response::ResponseNote> &notes() const;
...
private:
    ...
    vector_t<ql::datum_t> data_;
    vector_t<Response::ResponseNote> notes_;
